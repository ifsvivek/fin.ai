...
def chatGPT(text):
    ...
    completion = client.completions.create(
        model="text-davinci-003", prompt=text, max_tokens=4000, temperature=0.6
    )
...
def get_predict_message(country):
    ...
    prompt = "Hi, my country is {}. Kindly create a comprehensive list of places I can look out for to get a good loan for my small business establishment both in my country and other countries. Make sure you give the countries of the other countries! Give the answer strictly in this format: {}. Thanks.".format(
        country, format
    )
...
def get_business_idea(
    ...
    if capital_loan == "capital":
        ...
        prompt = "Hi, I'm from {}. Kindly help curate few nice business ideas, the domain sector of the business and like to learn more on the business, considering that I got a loan of {} US Dollars and I am meant to pay back in {} months time. My domain of business interest is {} and the country where I want to have my business is {}. Give the answer strictly in this format: {} Thanks.".format(
            country, amount, loan_pay_month, domain_interest, country_interest, format
        )
